...
DEFAULT_CONFIG = {
    ...
    "client": {
        ...
        "default_option_contract_size": 100, # 期权默认合约数量
        "default_option_contract_multiplier": 100,  # 期权默认合约乘数
        "default_option_exercise_price": 50.00,  # 期权默认行权价
        "default_option_premium_rate": 0.05,        # 场外期权默认权利金/名义本金比例 5%
        "default_option_margin_rate": 0.12,         # 场外期权默认保证金/名义本金比例 20%
